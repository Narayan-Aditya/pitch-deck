...
export async function scrapeInstagram(username) {
  ...
  return {
    ...
    // browse2api's profile object carries neither, and nothing downstream
    // requires them. Apify's does carry both, so when the fallback answers
    // they arrive for free.
